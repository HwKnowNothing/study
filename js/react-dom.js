...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('js/react')) :
	typeof define === 'function' && define.amd ? define(['js/react'], factory) :
        ...
        if ((_workInProgress.mode & ConcurrentMode) === NoEffect) {
          ...
          if (sourceFiber.tag === ClassComponent) {
            ...
            if (_current === null) {
              ...
              // completed components. For example, we should not call
...

{
  ...
  warnAboutUpdateOnUnmounted = function (fiber) {
    ...
    warningWithoutStack$1(false, "Can't call setState (or forceUpdate) on an unmounted components. This " + 'is a no-op, but it indicates a memory leak in your application. To ' + 'fix, cancel all subscriptions and asynchronous tasks in the ' + 'componentWillUnmount method.%s', getStackByFiberInDevAndProd(fiber));
